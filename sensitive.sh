...
replacevar ALGOLIA_APP_ID $ALGOLIA_APP_ID $THEME_CONFIG_FILE
replacevar ALGOLIA_API_KEY $ALGOLIA_API_KEY $THEME_CONFIG_FILE
replacevar ALGOLIA_ADMIN_API_KEY $ALGOLIA_ADMIN_API_KEY $THEME_CONFIG_FILE
